...
#playHand({'e': 2, 'h': 2, 'l': 1, 'o': 1, 't': 3, 'y': 1}, loadWords(), 7)
...
def playGame(wordList):
    ...
    count = 0
    while True:
        respond = raw_input("Enter n to deal a new hand, r to replay the last hand, or e to end game: n")
        if respond == 'n':
            count = 1
            current_hand = dealHand(HAND_SIZE)
            playHand(current_hand , wordList, HAND_SIZE)
        elif respond == 'r' and count == 0:
            print "You have not played a hand yet. Please play a new hand first!"
        elif respond == 'r' and count >=1:
            playHand(current_hand, wordList, HAND_SIZE)
        elif respond == 'e':
            break
        else:
